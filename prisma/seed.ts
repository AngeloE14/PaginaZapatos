  ...
  const products = [
    {
      ...
      description: 'Zapatillas urbanas clásicas en color negro, perfectas para el día a día.',
    ...
    },
    {
      ...
      description: 'Zapatillas deportivas en blanco.',
      sizes: '6,7,8,9,10,11'
    },
    {
      name: 'Black Pro',
      ...
      description: 'Edición profesional en negro con refuerzos estratégicos.',
    ...
    },
    {
      ...
      description: 'Zapatillas urbanas en rojo vibrante para destacar tu estilo.',
      sizes: '7,8,9,10,11'
    }
  ];
